const experiences = [
  {
    ...
    company: "Google Developer Group (GDG), IIIT Sri City",
    description:
  ...
  },
  {
    period: "2024",
    role: "PR Team Member",
    company: "Web3ssh, IIIT Sri City",
    description:
      "Part of the PR team at Web3ssh, IIIT Sri City, helping promote technical events and supporting community outreach activities.",
    technologies: ["Communication", "Outreach", "Teamwork"],
    current: true,
  },
  {
    period: "2024",
    role: "Operations & Logistics Team",
    company: "TEDx IIIT Sri City",
    description:
    ...
    <section id="experience" className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          >
            A timeline of my journey from testing real world platforms and
            contributing to developer communities, to building full stack
            projects and growing as a backend developer.
          </p>
        </div>
